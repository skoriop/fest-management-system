...
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20220022@hyderabad.bits-pilani.ac.in', 'Karthik Prakash' , '9597735353', TRUE, '2022A7PS0022H');
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20220037@hyderabad.bits-pilani.ac.in', 'Kishan Abijay', '9597735363', TRUE, '2022A7PS0037H');
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20216969@hyderabad.bits-pilani.ac.in', 'Soumitra Shewale', '8483302444', TRUE, '2021A7PS6969H');
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20210420@hyderabad.bits-pilani.ac.in', 'Kovid Lakhera', '7342264531', TRUE, '2021A7PS0420H');
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20220010@hyderabad.bits-pilani.ac.in', 'Varun Reddy Padala' , '8330027354', TRUE, '2022A7PS0010H');
INSERT INTO users (email, name, phone_number, from_bits, bits_id) VALUES ('f20231234@hyderabad.bits-pilani.ac.in', 'Zeeshan Ahmed', '9876543210', TRUE, '2023A7PS1234H');
INSERT INTO users (email, name, phone_number, from_bits, affiliation) VALUES ('skoriop@gmail.com', 'Sai Koriopan', '9876693210', FALSE, 'Malla Reddy Engineering College');
INSERT INTO users (email, name, phone_number, from_bits, affiliation) VALUES ('manjustman@gmail.com', 'Manjunath', '3278834527', FALSE, 'Dulla Reddy Arts College');
INSERT INTO users (email, name, phone_number, from_bits, affiliation) VALUES ('jamescorden@gmail.com', 'James Corden', '3529945320', FALSE, 'The Late Late Show');
INSERT INTO users (email, name, phone_number, from_bits, affiliation) VALUES ('zuck@facebook.com', 'Mark Zuckerberg', '238329122', FALSE, 'Facebook');
INSERT INTO users (email, name, phone_number, from_bits, affiliation) VALUES ('richardstallman@gnu.org', 'Richard Stallman', '5327748261', FALSE, 'GNU');
...
INSERT INTO cart_items (order_id, item_id, quantity) VALUES (3, 4, 1);
