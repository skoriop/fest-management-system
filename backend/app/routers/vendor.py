...
async def create(vendor: Vendor):
    try:
        ...
        return {"message": "Vendor created successfully", "data": created_vendor}
...
async def get(vendor_id: int):
    try:
        ...
        return {"message": None, "data": vendor}
...
@router.post("/vendor/{vendor_id}/update")
async def update(vendor_id: int, vendor: Vendor):
    try:
        updated_vendor = vendor_api.update_vendor(vendor_id, vendor)
        return {"message": "Vendor updated successfully", "data": updated_vendor}
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"An error occurred: ${str(e)}")


@router.post("/vendor/{vendor_id}/delete")
async def delete_vendor(vendor_id: int):
    try:
        vendor_api.delete_vendor(vendor_id)
        return {"message": "Vendor deleted successfully", "data": None}
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"An error occurred: ${str(e)}")
...
async def get_all_vendors():
    try:
        ...
        return {"message": "Success", "data": vendors}
    except HTTPException as e:
        raise e
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"An error occurred: ${str(e)}")
...
@router.get("/vendor/{vendor_id}/sales")
